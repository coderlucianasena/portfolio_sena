  ...
  return (
    <section id="home" className="hero-section min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto pt-16 sm:pt-20 md:pt-24 lg:pt-28 xl:pt-32">
          ...
          <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 h-8 sm:h-10 md:h-12">
            <span>{currentText}</span>
            <span className="animate-pulse">|</span>
          </div>

          <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 sm:mb-10 lg:mb-12 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-8 sm:mb-10 lg:mb-12 px-4 sm:px-0">
            <Button 
              size="lg" 
          ...
          <div className="flex justify-center space-x-4 sm:space-x-6 mb-8 sm:mb-10 lg:mb-12">
            <a 
              href="#" 
              className="p-2 sm:p-3 rounded-full bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
            >
              <Github className="h-5 w-5 sm:h-6 sm:w-6 text-gray-700 dark:text-gray-300" />
            </a>
            <a 
              href="#" 
